        ...
        <>
          <View style={styles.promptCard}>
            ...
            <View style={styles.promptContent}>
              ...
              <Text style={styles.promptText}>• Select a sport tab to see specific analytics</Text>
              <Text style={styles.promptText}>• Use metric tabs (Overview, Trends, etc.) for different views</Text>
              <Text style={styles.promptText}>• Pull down to manually refresh data when needed</Text>
            </View>
          </View>
          ...
          <View style={styles.promptCard}>
            ...
            <View style={styles.promptContent}>
              ...
              <Text style={styles.promptText}>• "shooting percentage" for efficiency stats</Text>
              <Text style={styles.promptText}>• "home advantage" for venue-based trends</Text>
              <Text style={styles.promptText}>• "player trends" for individual performance</Text>
              <Text style={styles.promptText}>• "team defense" for defensive metrics</Text>
            </View>
          </View>
