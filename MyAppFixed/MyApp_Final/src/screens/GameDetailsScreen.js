...
export default function GameDetailsScreen() {
  ...
  // Other tab render functions (headtohead, matchup, boxscore, teamstats, playbyplay)
  // ... (Keep all existing tab render functions from original code)
...
// Note: All other existing styles remain the same, just make sure to add backgroundColor
// to all shadow styles as shown above. The key fixes are:
// 1. Added teamColorDotWrapper with background
// 2. Added advantageCardWrapper with background
// 3. Added backgroundColor to all shadow containers
// 4. Removed "View Advanced Analytics" button
// 5. Added prompts section for generating insights
