      ...
      <View key={`game-${game.id}-${index}`} style={styles.gameCard}>
        ...
        <View style={styles.gameActions}>
          <TouchableOpacity 
            ...
            onPress={() => Alert.alert('Stats', `Detailed stats for ${game.awayTeam} vs ${game.homeTeam}`)}
          >
          ...
          <TouchableOpacity 
            style={styles.actionButton}
            onPress={() => Alert.alert('Watch', `Watch ${game.awayTeam} vs ${game.homeTeam} live on ${game.broadcast?.network || game.channel}`)}
          >
          ...
          <TouchableOpacity 
            style={styles.actionButton}
            onPress={() => Alert.alert('Highlights', `View highlights for ${game.awayTeam} vs ${game.homeTeam}`)}
          >
