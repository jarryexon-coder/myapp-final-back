// File: src/components/RevenueCatGate.js - FIXED VERSION
...
const RevenueCatGate = ({ 
  ...
  // Use useCallback for navigation handler
  const handleUpgradePress = useCallback(() => {
    // Navigate to Premium screen with appropriate focus
    navigation.navigate('PremiumTab', { 
      screen: 'PremiumAccess',
      params: { 
        focus: requiredEntitlement === 'premium_access' ? 'subscriptions' : 'locks',
        feature: featureName
      }
    });
  }, [navigation, requiredEntitlement, featureName]);
