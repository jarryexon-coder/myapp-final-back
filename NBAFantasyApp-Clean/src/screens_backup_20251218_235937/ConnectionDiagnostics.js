...
const ConnectionDiagnostics = () => {
  ...
  const testURLs = [
    { name: 'Localhost:3000', url: 'https://pleasing-determination-production.up.railway.app/health' },
    { name: '127.0.0.1:3000', url: 'http://127.0.0.1:3000/health' },
    { name: 'pleasing-determination-production.up.railway.app', url: 'https://pleasing-determination-production.up.railway.app/health' },
    { name: 'Localhost NBA Games', url: 'https://pleasing-determination-production.up.railway.app/api/nba/games/today' },
    { name: '10.0.0.183 NBA Games', url: 'https://pleasing-determination-production.up.railway.app/api/nba/games/today' },
  ];
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.infoBox}>
        ...
        <Text>• Check that backend is running: curl https://pleasing-determination-production.up.railway.app/health</Text>
      ...
      <View style={styles.commandsBox}>
        ...
        <Text>1. Check backend: curl https://pleasing-determination-production.up.railway.app/health</Text>
